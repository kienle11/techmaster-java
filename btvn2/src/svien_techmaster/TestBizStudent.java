...
public class TestBizStudent {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("Điểm luôn là số dương. Mời nhập lần lượt lại các điểm Marketing, Sales");
            ...
            salesPoint = Double.parseDouble(scanner.nextLine());}
                ...
                System.out.println("Điểm luôn nhỏ hơn 10. Mời nhập lần lượt lại các điểm Marketing, Sales");
                marketingPoint = Double.parseDouble(scanner.nextLine());
                salesPoint = Double.parseDouble(scanner.nextLine());}
            else break;
